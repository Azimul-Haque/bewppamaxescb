                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        ...
                                        @if($user->isAmbassador())
                                          <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#payoutModal{{ $user->id }}" title="Edit">
                                                              ...
                                                              <div class="col-md-6">
                                                                  <div class="form-group">
                                                                      ...
                                                                      <div class="input-group">
                                                                          ...
                                                                          <input type="number" name="amount" class="form-control" placeholder="0.00" min="{{ $user->ambassadorProfile->balance > 500 ? 500 : 0}}" 
