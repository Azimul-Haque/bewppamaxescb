...
<head>
  ...
  @if (!Request::is('blogs', 'blogs/*', 'blog', 'blog/*'))
    <meta name="description" content="BCS Exam Aid: বিসিএস, ব্যাংক, প্রাইমারি, NTRCA এবং জুডিশিয়ারি (সহকারী জজ) সহ সকল সরকারি চাকরির পূর্ণাঙ্গ প্রস্তুতির সেরা অ্যাপ। ১,০০,০০০+ প্রশ্নব্যাংক, ২২০০+ সাব-টপিক এবং স্পেশাল মডেল টেস্টের মাধ্যমে ঘরে বসেই আপনার প্রস্তুতিকে করুন আরও নির্ভুল ও আত্মবিশ্বাসী।">
