          ...
          <div class="col-lg-6 col-md-12 col-12">
            <div class="header-content">
              ...
              <div class="button">
                ...
                <a href='https://play.google.com/store/apps/details?id=com.orbachinujbuk.bjsandbarexam' target="_blank"><img alt='Get it on Google Play' class="img-responsive" style="max-width: 250px; width: auto;" src='https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png'/></a>
              ...
              <div class="about-five-tab">
                ...
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-who" role="tabpanel" aria-labelledby="nav-who-tab">
                    <p>আমরা কয়েকজন বাংলাদেশ সিভিল সার্ভিসের প্রশাসন, পুলিশসহ শীর্ষ ক্যাডারের সদস্য, বিসিএস ও অন্যান্য সরকারি চাকরির পরীক্ষার এক্সপার্টদের সমন্বয়ে গঠিত টিম। বিগত বছরগুলোর প্রশ্ন বিশ্লেষণ, প্রশ্নের প্যাটার্ন অনুসন্ধান  ও সর্বোচ্চ স্ট্র্যাটেজি অনুধাবন করে আমরা বিজেএস ও বার কাউন্সিল পরীক্ষার্থীদের জন্য সর্বোত্তম সমাধানটি নিয়ে এসেছি।</p>
