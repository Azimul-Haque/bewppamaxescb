                          ...
                          @foreach($questions as $question)
                            <form method="post" action="{{ route('dashboard.questions.updatechangetopicbased', $question->id) }}">
                              <tr>
                                  ...
                                  <td>
                                    <select class="form-control form-control-sm topic-select-field" name="topicchangeid" id="topicchangeid{{ $question->id }}" id="topicchangeid{{ $question->id }}" data-saved-id="{{ $question->id }}" data-saved-text="{{ $question->topic->full_path ?? '' }}">
