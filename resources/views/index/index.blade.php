      ...
      <div class="modal-dialog modal-lg modal-success">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <a href="{{ route('blog.single', $blog->slug) }}" title="NSI নিয়োগ ২০২৫: পরীক্ষার ধাপ, প্রস্তুতি ও গুরুত্বপূর্ণ তথ্য">NSI নিয়োগ ২০২৫: পরীক্ষার ধাপ, প্রস্তুতি ও গুরুত্বপূর্ণ তথ্য</a>
          </div>
          <!-- Modal footer -->
