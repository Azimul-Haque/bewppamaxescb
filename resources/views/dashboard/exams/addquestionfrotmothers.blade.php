...
<script>
    ...
    $('#questionsetselect').change(function() {
      ...
      appendhtml += '<td width="20%"><input type="number" min="1" class="form-control" name="questionamount'+selectarray[1]+'" placeholder="প্রশ্নের সংখ্যা"></td>';
    ...
    function removeRow(rowid) {
      ...
      otherexamids = otherexamids.splice(otherexamids.indexOf(rowid), 1);
      $('#otherexamids').val(otherexamids);
    }
</script>
@endsection