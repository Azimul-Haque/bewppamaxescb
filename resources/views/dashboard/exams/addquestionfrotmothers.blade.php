...
<script>
    ...
    $('#questionsetselect').change(function() {
      ...
      appendhtml += '<td width="20%"><input class="form-control" name="questionamount'+selectarray[1]+'" placeholder="প্রশ্নের সংখ্যা"></td>';
      appendhtml += '<td align="right"><button type="button" class="btn btn-danger btn-sm" onclick="removeRow(tablerow'+selectarray[1]+')">x</button</td>';
      appendhtml += '</tr>';
