...
@section('content')
    ...
    </div> <div class="modal fade" id="addExamModal" tabindex="-1" role="dialog" aria-labelledby="addExamModalLabel" aria-hidden="true" data-backdrop="static">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header bg-success">
              ...
              <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-check-inline">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="alltimeavailability" value="1">সব সময় এভেইলেবল
                              </label>
                            </div>
                        </div>
                        <div class="col-md-12">
