...
@section('title') {{ $blogger->name }} | ব্লগ-Blog | BCS Exam Aid - বিসিএস ও সরকারি চাকরির সেরা প্ল্যাটফর্ম @endsection
...
@section('meta-data')
    ...
    <script type="application/ld+json">
        ...
        "description": "{{ $blogger->name }}-টপিকের উপরে বিসিএস এক্সাম এইডের সকল ব্লগ পাচ্ছেন এই পাতায়। বিসিএস ও সরকারি চাকরির পূর্ণান্নগ প্রস্তুতি হোক এখানেই!",
