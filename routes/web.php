...
Route::post('/dashboard/exams/add/question/from/other/questions/$id', 'ExamController@storeQuestionFromOthers')->name('dashboard.exams.question.from.others.store');
