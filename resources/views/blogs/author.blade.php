    ...
    <div class="container">
	    <div class="row">
	    	@foreach($blogger->blogs as $blog)
		     	<div class="col-md-4">
					<div class="blog-listing blog-listing-classic no-margin-top wow fadeIn" style="margin-bottom: 20px; background-color: #FFFFFF; border-radius: 20px; border: 1px solid #F4F4F4;">
			            <!-- post image -->
