...
<script>
    ...
    $('#questionsetselect').change(function() {
      ...
      var appendhtml = '<tr id="tablerow333'+selectarray[1]+'">';
      ...
      appendhtml += '<td align="right"><button type="button" class="btn btn-success btn-sm" onclick="removeRow(tablerow333'+selectarray[1]+')">X</button</td>';
      appendhtml += '</tr>';
