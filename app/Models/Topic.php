...
class Topic extends Model
{
    ...
    2. 🚀 Updated storeQuestion Method (Using the Roll-up)
    Now, the controller method uses this efficient roll-up logic.
    ...
    use App\Models\Topic; // Make sure Topic model is imported
    ...
    public function storeQuestion(Request $request)
    {
        ...
        // 1. Create and Save the Question 
        $question              = new Question;
        $question->topic_id    = $request->topic_id;
        // ... (other fields) ...
        $question->save(); 

        // 2. AGGREGATION FIX: Efficiently Recalculate and Roll-up Total Questions Sum
        // We use the topic ID from the request to find the topic that received the new question.
        ...
        // ... (tags, image upload, explanation, and redirect logic remain the same) ...
